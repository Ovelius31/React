                ...
                <nav className="-mx-3 space-y-3">
                    <div className="space-y-1"> 
                     <a className="flex items-center px-3 py-2 text-black transition-colors duration-300 transform rounded-lg dark:text-black hover:bg-blue-700 dark:hover:bg-blue-700 dark:hover:text-white hover:text-black active:bg-blue-700 active:text-white" href="/dashboard">
                        ...
                        <a className="flex items-center px-3 py-2 text-black transition-colors duration-300 transform rounded-lg dark:text-black hover:bg-blue-700 dark:hover:bg-blue-700 dark:hover:text-white hover:text-black active:bg-blue-700 active:text-white" href="/dataMaster">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
